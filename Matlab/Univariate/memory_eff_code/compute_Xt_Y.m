function [Xt_Y, Y] = compute_Xt_Y(data, Y)
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	if dims.dimType == 0 % general
		[Xt_Y, Y] = compute_Xt_Y_general(dims, Xparts, Y);
	end
	
	if dims.dimType == 1 % dim1
		[Xt_Y, Y] = compute_Xt_Y_dim1(dims, Xparts, Y);
	end
	
	if dims.dimType == 2 % dim2
		[Xt_Y, Y] = compute_Xt_Y_dim2(dims, Xparts, Y);
	end
	
	if dims.dimType == 3 % dim3
		[Xt_Y, Y] = compute_Xt_Y_dim3(dims, Xparts, Y);
	end
end
